      ...
      <section className="animate-rise-up relative overflow-hidden rounded-[2.25rem] bg-slate-900 px-8 py-10 text-white shadow-2xl md:px-12 md:py-14">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          ...
          <div>
            ...
            <h1 className="mt-4 max-w-4xl text-4xl font-black leading-tight md:text-6xl">Kami ingin belanja kebutuhan harian terasa lebih nyaman, praktis, dan menyenangkan.</h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Toko Happy hadir untuk membantu member menemukan produk yang dibutuhkan dengan lebih cepat, tampilan yang mudah dipahami, dan pengalaman belanja yang terasa ringan dari awal sampai selesai.
            </p>
      ...
      <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <article className="animate-rise-up rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200" style={{ animationDelay: "80ms" }}>
          ...
          <p className="mt-5 leading-8 text-slate-600">
            Kami percaya pengalaman belanja yang baik bukan cuma soal harga, tapi juga soal kenyamanan. Karena itu, Toko Happy dirancang supaya member bisa menemukan produk lebih cepat, melihat detail dengan jelas, dan merasa nyaman saat
            berbelanja.
          </p>
        </article>
        ...
        <div className="grid gap-6">
          <article className="animate-rise-up overflow-hidden rounded-[2rem] bg-gradient-to-br from-emerald-500 to-emerald-700 p-8 text-white shadow-xl" style={{ animationDelay: "140ms" }}>
            ...
            <h2 className="mt-3 text-3xl font-black leading-tight">Kami ingin pengalaman belanja online terasa lebih jelas dan tidak ribet.</h2>

            <div className="mt-6 grid gap-4">
              {["Produk dipilih dengan kualitas yang nyaman dipakai sehari-hari.", "Tampilan toko dibuat sederhana supaya member mudah mencari barang.", "Pelayanan cepat dan responsif agar belanja terasa lebih tenang."].map((item) => (
      ...
      <section className="animate-rise-up rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200 md:p-10" style={{ animationDelay: "320ms" }}>
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-3xl leading-8 text-slate-600">Kami ingin setiap member merasa nyaman saat menjelajahi produk, melihat detail barang, hingga menyelesaikan pesanan.</p>
          </div>
