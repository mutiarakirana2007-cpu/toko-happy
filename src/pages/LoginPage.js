  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
      ...
      <section className="rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-slate-200 lg:p-10">
        ...
        <div className="mt-6 rounded-2xl bg-slate-50 p-4 text-sm leading-7 text-slate-500">Belum punya akun? Cukup login menggunakan username apa saja untuk langsung masuk sebagai member.</div>
      </section>
    </div>
  );
}
